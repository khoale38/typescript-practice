...
var Temp = function () {
    ...
    return (react_1["default"].createElement("div", { className: "" }, gif != "" && imgsLoaded ? (react_1["default"].createElement("img", { src: gif, className: "customgif" })) : (react_1["default"].createElement("div", { className: "black-background " },
